  ...
  return (
    <div className="w-full h-auto flex flex-col items-center justify-center">
      <motion.div
        ...
        whileInView="visible"
        viewport={{ once: true }}
        className="Welcome-box py-[8px] px-[7px] border border-[#7042f88b] opacity-[0.9] flex items-center gap-2 rounded-xl"
      >
        <Sparkles className="text-[#b49bff] h-5 w-5" />
        <h1 className="Welcome-text text-[13px]">
          Think better with modern React
        </h1>
      </motion.div>
      <motion.div
      ...
      <motion.div
        ...
        whileInView="visible"
        viewport={{ once: true }}
        className="cursive text-[20px] text-foreground/70 mb-10 mt-[10px] text-center"
      >
