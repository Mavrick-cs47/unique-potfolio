export type SkillLogo = { Image: string; width: number; height: number };

export const Skill_data: SkillLogo[] = [
  {
    Image:
...
export const Frontend_skill: SkillLogo[] = [
  {
    Image: "https://www.vectorlogo.zone/logos/reactjs/reactjs-icon.svg",
    width: 60,
    height: 60,
  ...
  {
    Image: "https://www.vectorlogo.zone/logos/threejs/threejs-icon.svg",
    width: 60,
    height: 60,
  },
  {
    Image: "https://www.vectorlogo.zone/logos/vitejsdev/vitejsdev-icon.svg",
    width: 60,
    height: 60,
  },
  {
...
export const Backend_skill: SkillLogo[] = [
  {
...
export const Full_stack: SkillLogo[] = [
  {
  ...
  {
    Image: "https://www.vectorlogo.zone/logos/reduxjs/reduxjs-icon.svg",
    width: 60,
    height: 60,
  },
];

export const Other_skill: SkillLogo[] = [
  {
